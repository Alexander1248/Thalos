...
public class FastADAM extends LearningRule {
    ...
    public FastADAM(double learningSpeed, double beta1, double beta2) {
        super(learningSpeed);
        this.beta1 = beta1;
        this.beta2 = beta2;
    }
    ...
    public static class Builder {
        ...
        public FastADAM build() {
            return new FastADAM(learningSpeed, beta1, beta2);
        }
    }
}
